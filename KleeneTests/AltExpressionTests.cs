...
namespace KleeneTests
{
    public class AltExpressionTests
    {
        ...
        //         new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(null!);
        //     });
        // }
        ...
        //         new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(new Expression<ConstantStructure<char>, ConstantStructure<char>>[] {
        //             null!
        //         });
        //     });
        // }
        ...
        //     Assert.Throws<ArgumentException>(() => {
        //         new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(new Expression<ConstantStructure<char>, ConstantStructure<char>>[] {
        //             new ConstantExpression<ConstantStructure<char>>('c'),
        //             null!
        //         });
        //     });
        // }
        ...
        //     // Given
        //     var expression = new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(new[] {
        //         new ConstantExpression<ConstantStructure<char>>('x'),
        //         new ConstantExpression<ConstantStructure<char>>('y')
        //     });
        ...
        //     // Given
        //     var expression = new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(new[] {
        //         new ConstantExpression<ConstantStructure<char>>(c1),
        //         new ConstantExpression<ConstantStructure<char>>(c2)
        //     });
        //     var input = new[] { c1 };
        ...
        //         new ConstantExpression<ConstantStructure<char>>(c1),
        //         new ConstantExpression<ConstantStructure<char>>(c2),
        //         new ConstantExpression<ConstantStructure<char>>(c3),
        //     });
        //     var input = new[] { c };
        ...
        // {
        //     // Given
        //     var expression = new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(new Expression<ConstantStructure<char>, ConstantStructure<char>>[] {
        //         new ConstantExpression<ConstantStructure<char>>(c1),
        //         new ProduceExpression<ConstantStructure<char>, ConstantStructure<char>>(c2)
        //     });
        //     var input = new[] { c1 };
        ...
        // {
        //     // Given
        //     var expression = new AltExpression<ConstantStructure<char>, ConstantStructure<char>>(Enumerable.Empty<Expression<ConstantStructure<char>, ConstantStructure<char>>>());
